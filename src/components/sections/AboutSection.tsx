    ...
    <section id="about" className="relative min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 bg-[#0C0C0C] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto">
        ...
        <div className="mt-10 sm:mt-14 md:mt-16 w-full flex justify-center">
          <AnimatedText 
            text="I am a passionate 3D creator specializing in crafting striking environments, detailed models, and unforgettable digital experiences. I thrive on bringing imaginative concepts to life and working closely with clients to build something truly incredible together." 
            className="text-[#D7E2EA] font-medium leading-relaxed max-w-[700px] text-[clamp(1rem,2vw,1.35rem)] text-center"
          />
        </div>
